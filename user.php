...
<body id="page6">
    ...
    <section id="content"><div class="ic"></div>
        <div class="main" style="font-style:Monospace;">
            <div class="wrapper">
            	<article class="col-1">
                	<div class="indent-left" >
                        ...
                        <dl>
                           ...
                           <input type="button" class="button-2" style="font-size:25px;font-family:Monospace;" onClick="location.href='complaint.php'" value="Post Complaints/Reviews">
                        </dl>
                    </div>
                </article>
                <article class="col-2">
                	<h3 class="p1" style="font-size:30px;font-family:Monospace;" >User Profile</h3><br>
                    <?php
...
?>
                    <form id="contact-form" name="reg" method="post"  action="update.php" style="font-family:Monospace;font-size:20px;">                    
